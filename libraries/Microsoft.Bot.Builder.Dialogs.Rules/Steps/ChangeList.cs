...
{
    class ChangeList : DialogCommand
    {
        ...
        public ChangeList(ChangeListType changeType, string listProperty, string itemProperty)
        {
        ...
        protected override async Task<DialogTurnResult> OnRunCommandAsync(DialogContext dc, object options = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var list = dc.State.GetValue<List<object>>(listProperty);
            ...
            switch (changeType)
            {
                ...
                case ChangeListType.remove:
                    ...
                    if (item != null)
                    {
                        //serialized = new JavaScriptSerializer().Serialize(item);
                        lastResult = false;
                        list.Remove(item);
                    }
                    break;
